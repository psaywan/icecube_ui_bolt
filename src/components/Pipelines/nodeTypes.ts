...
export const NODE_TYPES: NodeTypeDefinition[] = [
  ...
  },
  {
    ...
    icon: '🔗',
    color: '#DD344C',
    description: 'Run AWS Glue ETL Job',
    configFields: [
      { name: 'jobName', label: 'Glue Job Name', type: 'text', required: true },
      { name: 'arguments', label: 'Job Arguments (JSON)', type: 'textarea', required: false, placeholder: '{"--key": "value"}' },
    ],
  },
  {
    id: 'azure-blob-read',
